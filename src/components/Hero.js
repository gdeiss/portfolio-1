...
function Hero(props) {
  ...
  return(
    <Jumbotron>
      <Container>
        <Row>
          <div class='col' style={{padding: "20px 0px 0px 40px"}}>
            <img src={images[index]} style = {imageStyle} alt="fireSpot"/>
          </div>
          <div class='col-9'>
            <Row>
              <h2 style={{ color: 'white', fontSize:'3em', padding: "40px 0px 0px 0px" }}> Student @ Carnegie Mellon University</h2>
            </Row>
            <Row>
              <h2 style={{ color: 'white', fontSize:'1.5em', padding: "0px 0px 0px 0px" }}> Statistics & Machine Learning</h2>
            </Row>
            <Row>
              <h2 style={{ color: 'white', fontSize:'1.3em', padding: "0px 0px 0px 0px" }}> Game Design</h2>
            </Row>
          </div>
        </Row>
        <Row>
